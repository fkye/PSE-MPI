...
void KModule::prepare(const Interpreter::ModuleOptions &opts,
  ...
  // Extra analysis passes for MPI
  LegacyLLVMPassManagerTy pmMPI;
  pmMPI.add(createLoopSimplifyPass());
  pmMPI.add(new LoopInfo());
  pmMPI.add(new MainWrapperPass());
  pmMPI.add(new LoopMarkerPass());
  if (CountMPI)
    pmMPI.add(new MPICounterPass());
  pmMPI.run(*module);
