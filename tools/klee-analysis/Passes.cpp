...
/// \file
///
/// This file is borrowed from LLVM 3.6 opt tool, that provides the infrastructure
/// to parse and build a custom pass manager based on a commandline flag. It also
/// provides helpers to aid in analyzing, debugging, and testing pass structures.
///
//===----------------------------------------------------------------------===//
