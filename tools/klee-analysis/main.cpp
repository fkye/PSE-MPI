//===- The LLVM pre-analysis for klee  -------------------------------===//
//
//    
//
...
static cl::opt<bool>
MPIAuxAnalyses("mpiaux",
	   cl::desc("The auxliary analyses for MPI related issues"));
...
int main(int argc, char **argv) {
  ...
  // Check if it is necessary to add the MPI auxilary analyses
  if (MPIAuxAnalyses) {
    ModulePass * mpiAux = createMPIAuxAnalysesPass();
    addPass(Passes, mpiAux);
  }
